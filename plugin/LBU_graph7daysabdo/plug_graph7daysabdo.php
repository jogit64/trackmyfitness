<?php
/*
Plugin Name: 0_LBU_graph7daysabdos
Description: Affiche les dernières mesures d'abdominaux de l'utilisateur sous forme de graphique.
Version: 1.0
Author: Le Bon Univers
*/

function graphique_abdos_shortcode()
{
    ...
    $query = $bdd->prepare("SELECT series_abdominaux, quantite_abdominaux, total_abdominaux, day FROM performances WHERE user_id = :user_id ORDER BY day DESC LIMIT 7");
    ...
    foreach ($results as $result) {
        ...
        $data_series[] = $result['series_abdominaux'];
        $data_quantite[] = $result['quantite_abdominaux'];
        $data_total[] = $result['total_abdominaux'];
    }
    ...
    $html .= '<canvas id="graphique-abdos" class="graph"></canvas>';
    $html .= '</div>';
    $html .= '<style>';
    ...
    $html .= '</style>';
    $html .= '<script>';
    $html .= 'var ctx = document.getElementById("graphique-abdos").getContext("2d");';
    ...
    $html .= '        datasets: [';
    $html .= '            {';
    $html .= '                label: "Séries d\'abdominaux",';
    ...
    $html .= '            },';
    $html .= '            {';
    $html .= '                label: "Quantité d\'abdominaux",';
...
add_shortcode('plug_graph7daysabdos', 'graphique_abdos_shortcode');
