...
function get_user_performances_for_modify()
{
    ...
    $url = plugins_url('/LBU_modifydata7daysperf');
    ...
    foreach ($last_records as $record) {
        ...
        echo '  <button type="submit" class="edit-button--s delete-button inline-block">Supprimer</button>';
        echo '</div>';

        // Affichage du record avec le style personnalisé
        echo '<div class="category" id="poids">';
        echo '<li><span class="category-title">Poids</span></li>'; // Ajout du titre de la catégorie
        echo '<ul>'; // Début de la liste
        echo '<li><span>Poids :  ' . $record['poids_kg'] . ' kg</span></li>';
        echo '<li><span>Pourcentage de graisse : ' . $record['pourcentage_gras'] . ' %</span></li>';
        echo '<li><span>Nombre IMC : ' . $record['nombre_imc'] . '</span></li>';
        echo '</ul>'; // Fin de la liste

        // Boutons et formulaire
        echo '<div>';
        echo '<button class="edit-button inline-block" data-category="poids">Modifier</button>';
        echo '<form id="delete-form" class="inline-form" method="POST" action="' . $url . '/traitementsup.php">';
        ...
        echo '<form class="edit-form" style="display: none;" method="POST" action="' . $url . '/traitement.php?form=poids">';
        echo '  <input type="hidden" name="record_id" value="' . $record['id'] . '">';
        echo '  <input type="hidden" name="form" value="poids">';
        echo '  <input type="hidden" name="form" value="poids">';

        echo '  <label for="poids">Poids (kg)</label>';
        echo '  <input type="number" name="poids_kg" id="poids_kg" value="' . $record['poids_kg'] . '" step="0.1">';
        echo '  <label for="pourcentage_gras">Pourcentage de graisse (%)</label>';
        echo
        '  <input type="number" name="pourcentage_gras" id="pourcentage_gras" value="' . $record['pourcentage_gras'] . '" step="0.1">';
        echo '  <label for="nombre_imc">Nombre IMC</label>';
        echo
        '  <input type="number" name="nombre_imc" id="nombre_imc" value="' . $record['nombre_imc'] . '" step="0.1">';
        ...
        foreach ($sportlist_true as $id) {
            switch ($id) {
                case 'velo_elliptique':
                    ...
                    echo '    <input type="hidden" name="form" value="elliptique">';
                    echo '    <input type="hidden" name="record_id" value="' . $record['id'] . '">';
                ...
                case 'pompes':
                    ...
                    echo '    <input type="hidden" name="form" value="pompes">';
                    echo '    <input type="hidden" name="record_id" value="' . $record['id'] . '">';
                ...
                case 'abdominaux':
                    ...
                    echo '    <input type="hidden" name="form" value="abdominaux">';
                    echo '    <input type="hidden" name="record_id" value="' . $record['id'] . '">';
                ...
                case 'squat':
                    ...
                    echo '    <input type="hidden" name="form" value="squat">';
                    echo '    <input type="hidden" name="record_id" value="' . $record['id'] . '">';
                ...
                case 'gainage':
                    ...
                    echo '    <input type="hidden" name="form" value="gainage">';
                    echo '    <input type="hidden" name="record_id" value="' . $record['id'] . '">';
                ...
                case 'traction':
                    ...
                    echo '    <input type="hidden" name="form" value="traction">';
                    echo '    <input type="hidden" name="record_id" value="' . $record['id'] . '">';
                ...
                case 'musculation':
                    ...
                    echo '    <input type="hidden" name="form" value="musculation">';
                    echo '    <input type="hidden" name="record_id" value="' . $record['id'] . '">';
                ...
                case 'boxe':
                    ...
                    echo '    <input type="hidden" name="form" value="boxe">';
                    echo '    <input type="hidden" name="record_id" value="' . $record['id'] . '">';
                ...
                case 'marche':
                    ...
                    echo '    <input type="hidden" name="form" value="marche">';
                    echo '    <input type="hidden" name="record_id" value="' . $record['id'] . '">';
