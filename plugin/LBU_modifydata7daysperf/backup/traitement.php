...
if (isset($_GET['form']) && $_GET['form'] == 'pompes') {
    ...
    // Préparer la requête de mise à jour
    $query = $bdd->prepare("UPDATE performances SET series_pompes = :series_pompes, quantite_pompes = :quantite_pompes WHERE id = :record_id");
...
if (isset($_GET['form']) && $_GET['form'] == 'abdominaux') {
    ...
    // Préparer la requête de mise à jour
    $query = $bdd->prepare("UPDATE performances SET series_abdominaux = :series_abdominaux, quantite_abdominaux = :quantite_abdominaux WHERE id = :record_id");
...
if (isset($_GET['form']) && $_GET['form'] == 'squat') {
    ...
    // Préparer la requête de mise à jour
    $query = $bdd->prepare("UPDATE performances SET series_squats = :series_squats, quantite_squats = :quantite_squats WHERE id = :record_id");
...
if (isset($_GET['form']) && $_GET['form'] == 'traction') {
    ...
    // Préparer la requête de mise à jour
    $query = $bdd->prepare("UPDATE performances SET series_tractions = :series_tractions, quantite_tractions = :quantite_tractions WHERE id = :record_id");
...
if (isset($_GET['category']) && $_GET['category'] == 'marche') {
    // Récupérer les données du formulaire
    $category = $_POST['category'];
    $record_id = $_POST['record_id'];
