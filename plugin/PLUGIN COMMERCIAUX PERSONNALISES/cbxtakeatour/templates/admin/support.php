        ...
        <div class="row">
            <div class="col-6">
                                    ...
                                    <div class="feature-card-body static">
                                        <div class="feature-card-header">
                                            <a href="<?php echo esc_url($plugin_url); ?>" target="_blank">
                                                <img src="https://codeboxr.com/wp-content/uploads/productshots/18278-profile.png" alt="Pro features for CBX Tour plugin"/>
                                            </a>
                                        </div>
                                        <div class="feature-card-description">
                                            <h3>
                                                <a href="<?php echo esc_url($plugin_url); ?>"
                                                   target="_blank">CBX Tour – User Walkthroughs/Guided Tours Pro Addon</a></h3>
                ...
                <!--<div class="cbx-backend-card dashboard-plugin-Integration">
                    <div class="header">
                        <div class="text">
                            <h2><?php /*esc_html_e('Third Party plugin Integration', 'cbxtakeatour'); */ ?></h2>
                        </div>
                    </div>
                    <div class="content">
                        <div class="cbx-backend-settings-row">
                            <p>
                                ...
                                <?php /*esc_html_e('Coming Soon ...', 'cbxtakeatour'); */ ?></p>
                        </div>
                    </div>
                </div>-->
                    ...
                    <div class="content">
                        <div class="cbx-backend-settings-row">
                            <a href="https://codeboxr.com/contact-us" target="_blank">
                                ...
                                <?php esc_html_e('Access our Premium Support', 'cbxtakeatour'); ?></a>
                        </div>
                        <div class="cbx-backend-settings-row">
                            <a href="mailto:info@codeboxr.com&subject=Need%20support%20for%20CBX%20Take%20a%20Tour" target="_blank">
                                ...
                                <?php esc_html_e('Quick Support (Email)', 'cbxtakeatour'); ?></a>
                        </div>
                        <div class="cbx-backend-settings-row">
                            <a href="<?php echo esc_url($plugin_url); ?>" target="_blank">
                                <svg fill="none" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20">
                                ...
                                <?php esc_html_e('CBX Take a Tour Plugin Information', 'cbxtakeatour'); ?> </a>
                        </div>
                        <div class="cbx-backend-settings-row">
                            <a href="<?php echo esc_url($doc_url); ?>" target="_blank">
                                ...
                                <?php esc_html_e('Read the CBX Take a Tour User Guide', 'cbxtakeatour'); ?> </a>
                        </div>
                        <div class="cbx-backend-settings-row">
                            <a href="https://wordpress.org/support/plugin/cbxtakeatour/reviews/#new-post" target="_blank">
                                ...
                                <?php esc_html_e('Rate Our Plugin', 'cbxtakeatour'); ?> </a>
                        </div>
                    </div>
                </div>
                <div class="cbx-backend-card dashboard-changelog">
                    <div class="header">
                        <div class="text">
                            <h2><?php esc_html_e('Changelog', 'cbxtakeatour'); ?></h2>
                        </div>
                    </div>
                    <div class="content">
                        <div class="cbx-backend-settings-row">
                            ...
                            <ul>
                                <li>[Improvements] Minor improvements and bug fixes.</li>
                            </ul>
                        </div>
                        <div class="cbx-backend-settings-row">
                            <p>
