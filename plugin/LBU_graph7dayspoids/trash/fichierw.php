...
_data); ?>;
    ...
    // Appelle la fonction updateChart lors de la soumission du formulaire indépendant
    $('#independent-form').submit(function(event) {
...
// Ajoute l'attribut autocomplete=off au formulaire indépendant pour empêcher la mise en cache des données
function independent_form_autocomplete_off()
{
    echo '<script>jQuery(document).ready(function($) {$("#independent-form").attr("autocomplete", "off");});</script>';
}
add_action('wp_head', 'independent_form_autocomplete_off');