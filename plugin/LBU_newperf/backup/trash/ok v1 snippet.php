    ...
    foreach ($sportlist_true as $id) {
        switch ($id) {
            case 'velo_elliptique':
                ...
                //  echo '<li><span>Distance</span> <span data-field="distance_elliptique">' . $record['distance_elliptique'];
                echo '<li><span>Distance</span> <span data-field="distance_elliptique">' . $record['distance_elliptique'] . ' km</span></li>';
                //echo '<li><span>Calories</span> <span data-field="calories_elliptique">' . $record['calories_elliptique'];
                ...
                //   echo '<span data-field="category" style="display: none;">velo_elliptique</span>';
                ...
                //  echo '<script>console.log("Valeur de distance_elliptique : ' . $record['distance_elliptique'] . '")</script>';
                ...
                //echo '<script>console.log("Valeur de calories_elliptique : ' . $record['calories_elliptique'] . '")</script>';
            ...
            case 'marche':
                ...
                //echo '<li><span>Distance</span> <span data-field="distance_marche">' . $record['distance_marche'];
