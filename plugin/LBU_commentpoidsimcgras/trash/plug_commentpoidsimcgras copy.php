...
function get_user_performances()
{
    ...
    $query = "SELECT poids_kg, pourcentage_gras, nombre_imc FROM performances WHERE user_id = $user_id ORDER BY date DESC LIMIT 1";
    $result = $bdd->query($query)->fetch(PDO::FETCH_ASSOC);
